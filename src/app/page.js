			...
			<div className="flex  max-h-screen flex-col">
				...
				<div className="px-4 mb-2">
					...
					<h2 className="text-neutral-900 mt-4 text-sm xl:text-lg  ">
						I&apos;m fascinated with design, artificial intelligence, and competitive programming. If you want to learn more about me, check out my GitHub to see some cool projects that I&apos;ve worked on.
