...
export default function SEO({ title, desc }) {
	return (
		<Head>
			<title>{title ? title : fixed.title}</title>
			<link
			...
			<meta name="title" content={title ? title : fixed.title} />
			<meta name="description" content={desc ? desc : fixed.desc} />
			<meta property="og:type" content="website" />
			<meta property="og:url" content="https://www.ryanchou.dev/" />
			<meta property="og:title" content={title ? title : fixed.title} />
			<meta
				property="og:description"
				content={desc ? desc : fixed.desc}
			/>
			<meta
				property="og:image"
			...
			<meta
				...
				content={title ? title : fixed.title}
			/>
			<meta
